...
public class ManipularLibros implements Serializable{
    ...
    private Controles objetoarchivolibros = new Controles();
    /*
    ...
    */
    ...
    public Controles getObjetoarchivolibros() {
        return objetoarchivolibros;
    }

    public void setObjetoarchivolibros(Controles objetoarchivolibros) {
